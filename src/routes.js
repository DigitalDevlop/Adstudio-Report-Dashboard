...
const SSPDashboard = React.lazy(() =>
  import("./views/Dashboard/publisher_dashboard/index")
);
const DSPDashboard = React.lazy(() =>
  import("./views/Dashboard/advertiser_Dashbord/index")
);

const DSPCDashboard = React.lazy(() =>
  import(
    "./views/Dashboard/advertiser_Dashbord/advertiser_Details/advertiserDetails"
  )
);
...
const routes = [
  ...
  { path: "/sspdashboard", name: "Dashboard", element: SSPDashboard },
  { path: "/dspdashboard", name: "Dashboard", element: DSPDashboard },
  { path: "/dspdashboard/details", name: "Details", element: DSPCDashboard },
