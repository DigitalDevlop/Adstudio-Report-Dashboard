    ...
    <CRow>
      <CCol sm={6} lg={3}>
        <CWidgetStatsA
          className="mb-4"
          color="info"
          value={formatNumber(totalReachedImpressions)}
          title="Impressions"
          action={
      ...
      <CCol sm={6} lg={3}>
        <CWidgetStatsA
          className="mb-4"
          color="warning"
          value={formatNumber(totalAchievedClicks)}
          title="Clicks"
          action={
            <CDropdown alignment="end">
              <CDropdownToggle
      ...
      <CCol sm={6} lg={3}>
        <CWidgetStatsA
          className="mb-4"
          color="danger"
          value={numeral(totalCampaignBudget).format("0,0.00")}
          title="Budget(LKR)"
          action={
            <CDropdown alignment="end">
              <CDropdownToggle
      ...
      <CCol sm={6} lg={3}>
        <CWidgetStatsA
          className="mb-4"
          color="primary"
          value={numeral(totalUtilizedBudget).format("0,0.00")}
          title="Spent(LKR)"
          action={
            <CDropdown alignment="end">
              <CDropdownToggle
      ...
      {/* <CCol sm={6} lg={3}>
        <CWidgetStatsA
          className="mb-4"
          color="info bg-secondary"
          value={formatNumber(data?.publisher_earnings)}
          title="eCPC(LKR)"
          action={
            <CDropdown alignment="end">
              <CDropdownToggle
...
export default DspWidgetsDropdown;
